...
<title>Inscription au site du département de chimie du Collège Lionel-Groulx</title>
<style>
/* -------------------------------------
    GLOBAL
------------------------------------- */
      ...
      <table>
        <tr>
          <td>
            ...
            <p>Afin de terminer votre inscription au site du département de chimie, vous devez suivre sur le lien ci-contre et vous connecter avec le mot-de-passe
               qui vous a été assigné. </p>
            <p>Nous vous suggérons de changer ce mot-de-passe une fois que vous serez connecté.</p>
