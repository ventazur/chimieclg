...
/*
if (strpos($config['domain'], 'chimieclg.ca'))
{
    $config['composer_autoload'] = TRUE;
}
else
...
if ($config['is_DEV'])
{
    $config['sess_save_path'] = '/var/www/ventbleu.com/chimie/sessions';
}
else
{
...
|--------------------------------------------------------------------------
|
| Regenerer la clef aleatoirement.
| Ne pas enregistrer ici.
|*/
$config['encryption_key'] = 'aabbbcccdddeeefffggghhhiiijjj1234';
